...
void TM_SPI1_INT_InitPins(TM_SPI_PinsPack_t pinspack) {
	...
	if (pinspack == TM_SPI_PinsPack_1) {
		...
		TM_GPIO_Init(GPIOA, GPIO_PIN_5, TM_GPIO_Mode_AF, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_High );
		TM_GPIO_Init(GPIOA, GPIO_PIN_6, TM_GPIO_Mode_IN, TM_GPIO_OType_PP, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_High );
#else
...
#endif
#if defined(GPIOB) && defined(GPIO_AFx_SPI1)
...
void TM_SPI2_INT_InitPins(TM_SPI_PinsPack_t pinspack) {
	...
	if (pinspack == TM_SPI_PinsPack_1) {
#if defined(STM32F1xx)
		TM_GPIO_Init(GPIOA, GPIO_PIN_13, TM_GPIO_Mode_AF, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_High );
		TM_GPIO_Init(GPIOA, GPIO_PIN_14, TM_GPIO_Mode_IN, TM_GPIO_OType_PP, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_High );
#else
...
#endif
#if defined(GPIOB) && defined(GPIO_AFx_SPI2)
	if (pinspack == TM_SPI_PinsPack_2) {
...
#endif
#if defined(GPIOI) && defined(GPIO_AFx_SPI2)
...
#endif
#if defined(GPIOB) && defined(GPIOI) && defined(GPIO_AFx_SPI2)
