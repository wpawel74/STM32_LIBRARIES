...
void TM_USART1_InitPins(TM_USART_PinsPack_t pinspack) {	
	...
	if (pinspack == TM_USART_PinsPack_1) {
		...
		TM_GPIO_Init(GPIOA, GPIO_PIN_9, TM_GPIO_Mode_AF, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_High );
		TM_GPIO_Init(GPIOA, GPIO_PIN_10, TM_GPIO_Mode_IN, TM_GPIO_OType_OD, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_High );
#else
...
#if defined(STM32F1xx)
		TM_GPIO_Init(GPIOB, GPIO_PIN_6, TM_GPIO_Mode_AF, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_High );
		TM_GPIO_Init(GPIOB, GPIO_PIN_7, TM_GPIO_Mode_IN, TM_GPIO_OType_OD, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_High );
#else
		TM_GPIO_InitAlternate(GPIOB, GPIO_PIN_6 | GPIO_PIN_7, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_High, GPIO_AF_USART1);
#endif // defined(STM32F1xx)
	}
#endif
#if defined(GPIO_AF_USART1)
	if (pinspack == TM_USART_PinsPack_Custom) {
		/* Init custom pins, callback used */
		TM_USART_InitCustomPinsCallback(USART1, GPIO_AF_USART1);
	}
#endif // defined(GPIO_AF_USART1)
}
#endif
...
void TM_USART2_InitPins(TM_USART_PinsPack_t pinspack) {
	...
	if (pinspack == TM_USART_PinsPack_1) {
#if defined(STM32F1xx)
		TM_GPIO_Init(GPIOA, GPIO_PIN_2, TM_GPIO_Mode_AF, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_High );
		TM_GPIO_Init(GPIOA, GPIO_PIN_3, TM_GPIO_Mode_IN, TM_GPIO_OType_OD, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_High );
#else
	...
	if (pinspack == TM_USART_PinsPack_2) {
#if defined(STM32F1xx)
		TM_GPIO_Init(GPIOD, GPIO_PIN_5, TM_GPIO_Mode_AF, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_High );
		TM_GPIO_Init(GPIOD, GPIO_PIN_6, TM_GPIO_Mode_IN, TM_GPIO_OType_OD, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_High );
#else
		TM_GPIO_InitAlternate(GPIOD, GPIO_PIN_5 | GPIO_PIN_6, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_High, GPIO_AF_USART2);
#endif // defined(STM32F1xx)
	}
#endif
#if defined(GPIO_AF_USART2)
	if (pinspack == TM_USART_PinsPack_Custom) {
		/* Init custom pins, callback used */
...
void TM_USART3_InitPins(TM_USART_PinsPack_t pinspack) {
	...
	if (pinspack == TM_USART_PinsPack_1) {
#if defined(STM32F1xx)
		TM_GPIO_Init(GPIOB, GPIO_PIN_10, TM_GPIO_Mode_AF, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_High );
		TM_GPIO_Init(GPIOB, GPIO_PIN_11, TM_GPIO_Mode_AF, TM_GPIO_OType_OD, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_High );
#else
...
#if defined(STM32F1xx)
		TM_GPIO_Init(GPIOA, GPIO_PIN_9, TM_GPIO_Mode_AF, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_High );
		TM_GPIO_Init(GPIOA, GPIO_PIN_10, TM_GPIO_Mode_AF, TM_GPIO_OType_OD, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_High );
#else
...
#if defined(STM32F1xx)
		TM_GPIO_Init(GPIOD, GPIO_PIN_8, TM_GPIO_Mode_AF, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_High );
		TM_GPIO_Init(GPIOD, GPIO_PIN_9, TM_GPIO_Mode_AF, TM_GPIO_OType_OD, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_High );
#else
		TM_GPIO_InitAlternate(GPIOD, GPIO_PIN_8 | GPIO_PIN_9, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_High, GPIO_AF_USART3);
#endif // defined(STM32F1xx)
	}
#endif
#if defined(GPIO_AF_USART3)
	if (pinspack == TM_USART_PinsPack_Custom) {
		/* Init custom pins, callback used */
...
#if defined UART4 && defined GPIO_AF_USART4
void TM_UART4_InitPins(TM_USART_PinsPack_t pinspack) {
	/* Init pins */
#if defined(GPIOA)
	if (pinspack == TM_USART_PinsPack_1) {
...
#if defined UART5 && defined GPIO_AF_USART5
void TM_UART5_InitPins(TM_USART_PinsPack_t pinspack) {
	/* Init pins */
...
#if defined USART6 && defined GPIO_AF_USART6
void TM_USART6_InitPins(TM_USART_PinsPack_t pinspack) {
	/* Init pins */
#if defined(GPIOC)
	if (pinspack == TM_USART_PinsPack_1) {
...
#if defined UART7 && defined GPIO_AF_USART7
void TM_UART7_InitPins(TM_USART_PinsPack_t pinspack) {
	/* Init pins */
#if defined(GPIOE)
	if (pinspack == TM_USART_PinsPack_1) {
...
#if defined UART8 && defined GPIO_AF_USART8
void TM_UART8_InitPins(TM_USART_PinsPack_t pinspack) {
	/* Init pins */
#if defined(GPIOE)
	if (pinspack == TM_USART_PinsPack_1) {
