...
//#define ONEWIRE_INPUT(structure)		TM_GPIO_SetPinAsInput(structure->GPIOx, (structure)->GPIO_Pin, TM_GPIO_PuPd_NOPULL)
//#define ONEWIRE_OUTPUT(structure)		TM_GPIO_SetPinAsOutput(structure->GPIOx, (structure)->GPIO_Pin, TM_GPIO_OType_OD)

//#define ONEWIRE_LOW(structure)			TM_OneWire_WriteLow(structure)
//#define ONEWIRE_HIGH(structure)			TM_OneWire_WriteHigh(structure)
#define ONEWIRE_INPUT(structure)		TM_OneWire_SetInput(structure)
#define ONEWIRE_OUTPUT(structure)		TM_OneWire_SetOutput(structure)
