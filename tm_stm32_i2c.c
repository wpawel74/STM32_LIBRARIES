...
#ifndef GPIO_AF_I2C1
		TM_GPIO_Init(GPIOB, GPIO_PIN_6 | GPIO_PIN_7, TM_GPIO_Mode_AF, TM_GPIO_OType_OD, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_High );
#else
...
void TM_I2C2_INT_InitPins(TM_I2C_PinsPack_t pinspack) {
	...
	if (pinspack == TM_I2C_PinsPack_1) {
#ifndef GPIO_AF_I2C1
		TM_GPIO_Init(GPIOB, GPIO_PIN_10 | GPIO_PIN_11, TM_GPIO_Mode_AF, TM_GPIO_OType_OD, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_High );
#else
